...
ani1[,3] <- as.numeric(levels(ani[,3]))[ani[,3]] #convert ANI column from factor to numeric
#if the above line errors, try the following line
#ani1$ANI.1..2. <- as.numeric(as.character(ani1$ANI.1..2.))
